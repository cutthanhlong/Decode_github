...
public final class HttpHost implements Cloneable, Serializable {
    ...
    public static HttpHost create(String str) {
        ...
        return new HttpHost(str, i6, str2);
    }
    ...
    public HttpHost(String str, int i6) {
    ...
    public HttpHost(InetAddress inetAddress, int i6, String str) {
        this((InetAddress) Args.notNull(inetAddress, "Inet address"), inetAddress.getHostName(), i6, str);
    }

    public HttpHost(InetAddress inetAddress, String str, int i6, String str2) {
    ...
    public HttpHost(InetAddress inetAddress, int i6) {
