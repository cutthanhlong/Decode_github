...
public class SublimeTimePicker extends FrameLayout implements RadialTimePickerView.OnValueSelectedListener {
    ...
    public SublimeTimePicker(Context context, AttributeSet attrs, int defStyleAttr) {
        super(SUtils.createThemeWrapper(context, R.attr.sublimePickerStyle, R.style.SublimePickerStyleLight, R.attr.spTimePickerStyle, R.style.SublimeTimePickerStyle), attrs, defStyleAttr);
        initializeLayout();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SublimeTimePicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(SUtils.createThemeWrapper(context, R.attr.sublimePickerStyle, R.style.SublimePickerStyleLight, R.attr.spTimePickerStyle, R.style.SublimeTimePickerStyle), attrs, defStyleAttr, defStyleRes);
        initializeLayout();
    }
    ...
    private CharSequence obtainVerbatim(String text) {
        return (SUtils.isApi_21_OrHigher()) ? new SpannableStringBuilder().append(text, new TtsSpan.VerbatimBuilder(text).build(), 0) : text;
    }
    ...
    private static class ClickActionDelegate extends AccessibilityDelegateCompat {
        ...
        public ClickActionDelegate(Context context, int resId) {
            ...
            mClickAction = new AccessibilityNodeInfoCompat.AccessibilityActionCompat(AccessibilityNodeInfoCompat.ACTION_CLICK, label);
        }
    ...
    private void updateHeaderAmPm() {
        if (mIs24HourView) {
            ...
            if (SUtils.isApi_18_OrHigher()) {
                ...
                timePattern = DateTimePatternHelper.getBestDateTimePattern(mCurrentLocale, DateTimePatternHelper.PATTERN_hm);
            }
    ...
    private void updateHeaderHour(int value, boolean announce) {
        ...
        if (SUtils.isApi_18_OrHigher()) {
            ...
            timePattern = DateTimePatternHelper.getBestDateTimePattern(mCurrentLocale, (mIs24HourView) ? DateTimePatternHelper.PATTERN_Hm : DateTimePatternHelper.PATTERN_hm);
        }
    ...
    private boolean addKeyIfLegal(int keyCode) {
        ...
        if ((mIs24HourView && mTypedTimes.size() == 4) || (!mIs24HourView && isTypedTimeFullyLegal())) {
            return false;
        }
    ...
    private final View.OnFocusChangeListener mFocusListener = new View.OnFocusChangeListener() {
        ...
        public void onFocusChange(View v, boolean hasFocus) {
            if (!hasFocus && mInKbMode && isTypedTimeFullyLegal()) {
                ...
                if (mOnTimeChangedListener != null) {
                    mOnTimeChangedListener.onTimeChanged(SublimeTimePicker.this, mRadialTimePickerView.getCurrentHour(), mRadialTimePickerView.getCurrentMinute());
                }
            }
        }
    };
